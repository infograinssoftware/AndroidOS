...
public class PostListActivity extends BaseActivity {
    ...
    public void init() {
        ...
        toolbar_title.setText(R.string.post_list);
        recyclerView = findViewById(R.id.recyclerView);
        postListAdapter = new PostListAdapter(context,sellList,"post");
                    ...
                    try {
                        if (response.body().getStatus() == 200) {
                            ...
                            for (int i = 0; i < ObjectList.size(); i++) {
                                ...
                                sellList.add(new UserList(ObjectList.get(i).getId(),img,ObjectList.get(i).getType(), ObjectList.get(i).getLocation(),""));
                            }
