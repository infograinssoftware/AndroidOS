package com.open_source.SignaturePack;
...
public class SignaturePad extends View {
    ...
    public SignaturePad(Context context, AttributeSet attrs) {
        ...
        //Configurable parameters
        try {
            mMinWidth = a.getDimensionPixelSize(R.styleable.SignaturePad_minWidth, convertDpToPx(3.2f));
            mMaxWidth = a.getDimensionPixelSize(R.styleable.SignaturePad_maxWidth, convertDpToPx(4.8f));
    ...
    public void setPenColorRes(int colorRes) {
        try {
            setPenColor(colorRes);
        } catch (Resources.NotFoundException ex) {
            setPenColor(R.color.black);
        }
    }
