...
public class SpRunningJobFragement extends Fragment {
    private static final String TAG = SpRunningJobFragement.class.getSimpleName();
    Toolbar toolbar;
    ...
    private void init_view() {
        ...
        toolbar_title.setText(R.string.running_project);
    ...
    private void FunGetData() {
        if (Utility.isConnectingToInternet(context)) {
            ...
            RetrofitClient.getAPIService().FunSpAwarted(SharedPref.getSharedPreferences(context, Constants.TOKEN), "2").enqueue(new Callback<RetrofitUserData>() {
                @Override
                public void onResponse(Call<RetrofitUserData> call, Response<RetrofitUserData> response) {
                    ...
                    try {
                        if (response.body().getStatus() == 200) {
                            ...
                            awardJobAdapter = new AwardJobAdapter(context, arrayList, "2","sp");
