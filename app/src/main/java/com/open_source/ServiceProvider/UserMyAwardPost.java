...
public class UserMyAwardPost extends Fragment {
    private static final String TAG = UserMyAwardPost.class.getSimpleName();
    Toolbar toolbar;
    ...
    private void init_view() {
        ...
        toolbar_title.setText(getString(R.string.awarded_project));
    ...
    private void FunGetData() {
        if (Utility.isConnectingToInternet(context)) {
            ...
            RetrofitClient.getAPIService().FunUserAwarted(SharedPref.getSharedPreferences(context, Constants.TOKEN),"1").enqueue(new Callback<RetrofitUserData>() {
                @Override
                public void onResponse(Call<RetrofitUserData> call, Response<RetrofitUserData> response) {
                    ...
                    try {
                        if (response.body().getStatus() == 200) {
                            ...
                            awardJobAdapter = new AwardJobAdapter(context, arrayList, "4","user");
