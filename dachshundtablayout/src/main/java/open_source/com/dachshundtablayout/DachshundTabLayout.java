package open_source.com.dachshundtablayout;
...
import open_source.com.dachshundtablayout.indicator.AnimatedIndicatorInterface;
import open_source.com.dachshundtablayout.indicator.AnimatedIndicatorType;
...
public class DachshundTabLayout extends TabLayout implements ViewPager.OnPageChangeListener {
    ...
    public DachshundTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mIndicatorColor = ta.getColor(R.styleable.DachshundTabLayout_ddIndicatorColor, Color.BLACK);
